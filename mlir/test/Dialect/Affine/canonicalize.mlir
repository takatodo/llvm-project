...
// CHECK-LABEL: func @extreme_single_iteration_loop_folded
func.func @extreme_single_iteration_loop_folded() -> (index, index) {
  %c0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
  %res:2 = affine.for %i = 0 to 9223372036854775807
      step 9223372036854775807
      iter_args(%arg0 = %c0, %arg1 = %c1) -> (index, index) {
    affine.yield %arg1, %arg0 : index, index
  }
